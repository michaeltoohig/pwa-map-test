// This is so much harder than I thought and not worth the effort at the moment. Just work within the confines of Leaflet for now.

<script>
import { optionsMerger, propsBinder, findRealParent } from 'vue2-leaflet/utils/utils.js';
